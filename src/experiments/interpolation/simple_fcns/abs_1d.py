...
if __name__ == "__main__":
    ...
    # 1. Neural network
    save_dir = f"/pscratch/sd/j/jwl50/interpolants-torch/plots/interpolation/abs_1d/mlp_sample={args.sample_type}"
    ...
    # 2. Polynomial interpolation
    save_dir = f"/pscratch/sd/j/jwl50/interpolants-torch/plots/interpolation/abs_1d/chebyshev_sample={args.sample_type}"
    n_epochs = args.n_epochs
    eval_every = 100
    lr = 1e-3
    ...
    # 3. Barycentric rational interpolation
    save_dir = f"/pscratch/sd/j/jwl50/interpolants-torch/plots/interpolation/abs_1d/rational_sample={args.sample_type}"
    n_epochs = args.n_epochs
    eval_every = 100
    lr = 1e-3
    basis_type = "chebyshev"
