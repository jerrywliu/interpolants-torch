...
plt.tight_layout()
plt.savefig("/pscratch/sd/j/jwl50/interpolants-torch/notebooks/figures/sin2d_interp_model=cheb_points=cheb_nx=21_ny=21.pdf")
plt.show()
...
plt.tight_layout()
plt.savefig("/pscratch/sd/j/jwl50/interpolants-torch/notebooks/figures/sin2d_interp_model=cheb_points=equispaced_nx=21_ny=21.pdf")
plt.show()
...
plt.tight_layout()
plt.savefig("/pscratch/sd/j/jwl50/interpolants-torch/notebooks/figures/sin2d_interp_model=fourier_nx=21_ny=21.pdf")
plt.show()
...
plt.tight_layout()
plt.savefig("/pscratch/sd/j/jwl50/interpolants-torch/notebooks/figures/sin2d_interp_model=mlp_nx=21_ny=21.pdf")
plt.show()
